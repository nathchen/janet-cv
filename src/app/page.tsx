    ...
    <div>
      <section className="relative isolate overflow-hidden text-white mb-10">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 sm:py-28">
          ...
          Portfolio showcasing motion graphics, UI/UX design, infographics, digital campaigns, point-of-sale displays, layouts, logos, and illustrations.
          </p>
          <div className="mt-8 flex flex-wrap gap-4">
            <Link href="/contact" className="px-5 py-2.5 rounded border border-green-500 text-green-500 hover:bg-green-500 hover:text-black transition-colors text-sm font-medium">
              Contact me
            </Link>
            <Link href="/cv" className="px-5 py-2.5 rounded bg-green-500 text-black hover:bg-green-400 transition-colors text-sm font-medium">
              View CV
            </Link>
          </div>
        </div>
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-12">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 text-sm">
          {[
            ...
            { href: "/infographic-design", icon: "infographic.png", label: "Infographic" },
            ...
            >
              <img src={`/icons/${item.icon}`} alt={item.label} className="w-40 h-40" />
              {/* {item.label} */}
            </Link>
          ))}
        </div>
